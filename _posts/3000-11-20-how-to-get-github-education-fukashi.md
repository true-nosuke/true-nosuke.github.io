...
permalink: /github_education_fukashi
--- 
...
- Microsoft Azure：クラウドサービスで利用可能な無料クレジットやサービスアクセス。
- DigitalOcean / Heroku：クラウドホスティングサービスで利用可能な無料クレジット。
- Namecheap / .tech：ドメイン名登録やSSL証明書の無料提供。
- 学習プラットフォーム：Datacamp、Frontend Mastersなどの学習コンテンツへの無料アクセスや割引。

特に、一番最初のGithub Proに含まれるGithub Copilotがとてつもなく便利！
さらに、Githubのサービスは使わなくても、Copilotのみを使うということも可能

「そんな特典、自分でも使えるの？」

特典を使うには簡単な申請が必要です。次に、その申請条件を見てみましょう。

**条件**
- 学生であること：大学、高等専門学校、専門学校など、認定された教育機関に在籍している必要があります。
...
- Name
  ここには、本名を入れてください。
  本名を入れることで、他の人からもその名前を閲覧することが可能になりますが、申請が承認された後、名前をニックネームに戻すことが可能です。
  名前は、日本語（漢字）で
  苗字 半角スペース 名前 
  の形式がベスト。
- Public email
...
### Billing informationを埋める

https://github.com/settings/billing/payment_information

このページから、アカウントのBilling Information（請求情報）を設定できます。ここに書かれた情報は、他の人からは見ることはできませんが、申請を承認してもらうためには書く必要があります。
...
写真を撮影したあと、Submit Applicationを押すことで申請は完了です。  
